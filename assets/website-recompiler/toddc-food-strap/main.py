...
# 0 - DEFINE CONSTS =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
ITEMS_CSV = "../../destiny-dc/items/food-strap/csv/food-strap.csv"
TAGS_CSV = "./data/tags.csv"
N_ROWS_PER_ENTRY = 2
N_START = 990
OUT_MD = "../../../projects/destiny-dc/items/food-strap.md"
...
![](../../../assets/destiny-dc/items/food-strap/img/{item_id}.png)  
"""
SEPARATOR = "\n---\n"
