...
#need to put back the way images are handled in DC

# main
if __name__ == "__main__":

    # 0 - DEFINE CONSTS
    GUIDE_PATH = "../../ndx/ndx-guide/csv/ndx-guide.csv"
    OUT_PATH = "../../../projects/ndx/ndx-guide.md"
    TITLE = "# Tales of Phantasia Narikiri Dungeon X - Side-Quest Guide\n"
