...
# 0 - DEFINE CONSTS =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
ITEMS_CSV = "../../destiny-dc/books/discovery-book/csv/discovery-book.csv"
TAGS_CSV = "./data/tags.csv"
N_ROWS_PER_ENTRY = 3
N_START = 1133
OUT_MD = "../../../projects/destiny-dc/books/discovery-book.md"
...
![](../../../assets/destiny-dc/books/discovery-book/img/{item_id}.png)  
"""
SEPARATOR = "\n---\n"
